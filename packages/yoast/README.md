...
[![Version](https://img.shields.io/npm/v/@frontity/yoast.svg)](https://www.npmjs.com/package/@frontity/yoast) [![npm](https://img.shields.io/npm/dw/@frontity/yoast)](https://www.npmjs.com/package/@frontity/yoast) [![License: Apache--2.0](https://img.shields.io/badge/license-Apache%202-lightgrey)](https://github.com/frontity/frontity/blob/master/LICENSE)

This package is designed to automatically get and render all the tags that the [Yoast
SEO](https://wordpress.org/plugins/wordpress-seo/) plugin for WordPress exposes
in the REST API, since its version 14.0.

For previous versions of the Yoast SEO plugin (<14.0), use the
...
> Comprehensive information about how to use the @frontity/yoast package can be found in the [docs](https://api.frontity.org/frontity-packages/features-packages/yoast).

## Feature Discussions

[**Feature Discussions**](https://community.frontity.org/c/feature-discussions/33) about Frontity are public. You can join the discussions, vote for those you're interested in or create new ones.

These are the ones related to this package: https://community.frontity.org/tags/c/feature-discussions/33/yoast
