...
This package defines the common [interface](https://www.typescriptlang.org/docs/handbook/interfaces.html) to build analytics packages for Frontity

Some packages that [implement this interface](https://www.npmjs.com/browse/depended/@frontity/analytics) are:
