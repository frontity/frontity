...
This package is designed to automatically get all the data that the [REST API Head Tags WordPress plugin](https://wordpress.org/plugins/rest-api-head-tags/) exposes in the REST API, depending on the URL.

**This package needs to be used together with the [REST API Head Tags WordPress plugin](https://wordpress.org/plugins/rest-api-head-tags/), so before installing this package you have to install the Head Tags plugin in your WordPress backend.**
