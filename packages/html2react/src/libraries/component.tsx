      ...
      return (
        <ClassNames>
          {({ css, cx }) => {
            ...
            // Destructure the className if it exists so that we can compose it
            // with the class generated by emotion and get the `props` variable
            // which does not contain className.
            ...
            return (
              <node.component
                {...{
                  ...
                  // props does not have the className because we destructured
                  // it before.
                  ...props,
                }}
              >
